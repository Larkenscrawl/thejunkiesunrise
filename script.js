function toggleText(element) {
    const textBlocks = {
        "block1": [
            ...
            `<span class="colored-text" style="color: blue;">having sex with the ghost trick. Afterwards, as the ghost trick was sleeping, her ghost self sat down on the floor, took a loaded syringe from her purse, shot up and nodded off. The ghost trick woke up a while later, took her purse, and took off.</span>`,
            `<span class="colored-text" style="color: green;">giving the ghost trick a few oxys. She noticed that her ghost self put a benzo in there by accident. The ghost trick crushed the pills and smoked them. He lay down in bed and after a while he stopped breathing. Her ghost self tried to shake him out of it but couldn’t. She said “oh shit” and bolted.</span>`
        ],
        "block2": [
            `<span class="colored-text" style="color: red;">“Fuck off,” she said.<br>“Don’t be like that, now, how about fifty?”<br>“Eat shit, I’m fourteen.”<br>“Stuck-up bitch” he said and left, trailing booze stink behind him.</span>`,
        ...
        "block3": [
            `<span class="colored-text" style="color: red;">“Just give me the black tar,” she said.<br>“Fine, suit yerself,” he said, swiveling around and opening the bottom drawer.</span>`,
            `<span class="colored-text" style="color: blue;">“Ok but gimme a fresh one” she said.<br>“Fresh spike for the princess…” he said, rummaging through the middle drawer.</span>`,
            `<span class="colored-text" style="color: green;">“Fine but can I borrow some cash? I need to get a tooth fixed. Tricks are complainin’” She said.<br>“Shitfire… Sure gimme a second” he unlocked the top drawer. She lunged at him and knocked him to the ground. As he was thrashing she took the money from the drawer and fled.</span>`
        ],
        "block4": [
            `<span class="colored-text" style="color: red;">“I can’t, Haley… I’ve tried…”<br>“Try again… You’re not a junkie, Maggie, you know that…”<br>“Just give me a few months…”<br>“You’ve said that before”<br>“Just a few months, so I can get my shit in order.”<br>“No, Maggie… I’m either driving you to the rehab center right now or you’re on your own.”<br>Maggie looked her sister in the eye, “Haley, you’re being mean.”<br>Haley wiped her tears, looked away. “I’m sorry Maggie… You should pack up, now.”</span>`,
            `<span class="colored-text" style="color: blue;">“I can’t, Haley…”<br>“Why? Me and Darryl will cover the expenses!”<br>“That’s not it…”<br>“What is it, then?”<br>“Something happened last time” Maggie said.<br>“What happened?”<br>“My roommate there… She did stuff to me…”<br>“Oh my God, Maggie… Maggie, oh my God, why didn’t you tell me?”<br>“I don’t know…”<br>“Listen, we’ll take you to a different one… Would you be okay with that? Could we do that?”<br>Maggie went silent.<br>“Please say yes” Haley said.<br>“Okay” Maggie said.<br>“Okay?”<br>“Okay” Maggie said between sobs.</span>`,
